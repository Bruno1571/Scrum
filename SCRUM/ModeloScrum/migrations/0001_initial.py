    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sprint_asignado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ModeloScrum.sprint')),
            ],
        ),
        migrations.AddField(
            model_name='sprint',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responsable', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('tareas_asociadas', models.ManyToManyField(blank=True, to='ModeloScrum.tarea')),
            ],
        ),
